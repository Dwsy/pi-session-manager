...
description: Browse, organize, and manage your Pi sessions across multiple views with live updates and batch workflows.
---
...
Hold `Option` (macOS) or `Alt` (Windows/Linux) and click to open a preview modal instead. This lets you quickly browse session content without leaving the list view. Click the expand button in the preview modal to open the full session viewer.
