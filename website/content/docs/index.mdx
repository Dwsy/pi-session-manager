...
- **Full-Text Search** — SQLite FTS5 with normalized indexing, role filters, session ID matching, and snippet highlighting
...
<Callout type="tip">
Live demo preview: [https://dwsy.github.io/pi-session-manager/demo/](https://dwsy.github.io/pi-session-manager/demo/)

Static dataset browser: [https://dwsy.github.io/pi-session-manager/dataset/](https://dwsy.github.io/pi-session-manager/dataset/)
</Callout>
