---
title: API Reference
description: HTTP, WebSocket, and SSE APIs for programmatic access to Pi Session Manager.
---

import { Callout } from 'fumadocs-ui/components/callout';

Pi Session Manager exposes its full capability surface through HTTP, WebSocket, and SSE APIs. The same command router powers all three transports, so session management, search, tags, model config, Pi Live, and terminal workflows stay consistent across clients.
