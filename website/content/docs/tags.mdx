...
<Callout type="info">
Tags are stored in the SQLite database (`~/.pi/agent/sessions/sessions.db`), not in the JSONL session files. This means tags are local to your Pi Session Manager instance.
</Callout>
