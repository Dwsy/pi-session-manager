...
export default function ScrollToBottomButton({
  ...
  return (
    <button
      ...
      style={style}
      className={`fixed left-1/2 bottom-4 z-10 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full bg-secondary text-foreground shadow-lg transition-all duration-150 hover:bg-secondary-hover ${
        visible
