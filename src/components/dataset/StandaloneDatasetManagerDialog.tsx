          ...
          <div className="rounded-md border border-border bg-secondary/20 p-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              <input
                ...
                className="min-w-0 flex-1 rounded-md border border-border bg-background px-4 py-2.5 text-sm text-foreground outline-none focus:border-info"
              />
              <div className="flex gap-2">
                <button
                  onClick={() => void refresh()}
                  disabled={loading}
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-border bg-background px-4 py-2.5 text-sm text-foreground hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-60"
                >
                  <RefreshCw
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-info/40 bg-info/10 px-4 py-2.5 text-sm font-medium text-foreground hover:bg-info/15 disabled:cursor-not-allowed disabled:opacity-60"
                >
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {!isCurrent && (
                        <button
                          ...
                          disabled={isBusy}
                          className="rounded-md border border-info/40 bg-info/10 px-3 py-2 text-sm font-medium text-foreground hover:bg-info/15 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          {t(
                      ...
                      <button
                        ...
                        disabled={isBusy}
                        className="inline-flex items-center gap-2 rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-60"
                      >
                      ...
                      {!isBuiltinDefault && !isCurrent && (
                        <button
                          ...
                          disabled={isBusy}
                          className="inline-flex items-center gap-2 rounded-md border border-destructive/30 bg-destructive/10 px-3 py-2 text-sm text-destructive hover:bg-destructive/15 disabled:cursor-not-allowed disabled:opacity-60"
                        >
