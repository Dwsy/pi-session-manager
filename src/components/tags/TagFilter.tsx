  ...
  return (
    <div className="border-b border-border/50">
      <button
        ...
        className="flex items-center gap-1.5 w-full px-3 py-2 text-[10px] font-medium text-muted-foreground uppercase tracking-wider hover:text-foreground motion-color focus-ring"
      >
          ...
          {tags.map(tag => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 w-full px-2 py-1 rounded text-left motion-color focus-ring ${
