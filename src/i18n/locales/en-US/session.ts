export const session = {
  ...
  convert: {
    ...
    targetDescriptions: {
      ...
      cursor: 'Read Cursor composer sessions. Cursor cannot be a conversion target.',
      antigravity: 'Read Antigravity CLI transcripts. Antigravity cannot be a conversion target.',
      aider: 'Append to an Aider markdown chat history.',
      amp: 'Write an Amp thread JSON.',
      chatgpt: 'Write a ChatGPT desktop conversation JSON.',
      cline: 'Write a Cline task conversation history.',
      openclaw: 'Write an OpenClaw session JSONL transcript.',
      vibe: 'Write a Vibe session JSONL transcript.',
      kiro: 'Write a Kiro CLI session file triplet.',
      grok: 'Write a Grok Build session directory.',
    },
  },
  header: {
    date: 'Date',
