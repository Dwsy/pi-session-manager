export const command = {
  ...
  commands: {
    ...
    requiresProject: 'Requires an active project',
    requiresSession: 'Requires an active session',
    unavailable: 'Unavailable in the current context',
    empty: 'No plugin commands registered',
    emptyForQuery: 'No commands found',
    emptyHint: 'Plugins can contribute actions with ctx.registerCommand(...).',
  },
  dev: {
    placeholder: 'Inspect dev plugins...',
    refresh: 'Refresh',
    loading: 'Loading dev plugins...',
    empty: 'No dev plugins',
    emptyHint: 'Add a dev project from Settings > Plugins > Developer.',
    summaryEmpty: 'No dev plugins loaded',
    summaryCount: '{{count}} dev plugins',
    summaryActive: '{{count}} active',
    summaryErrors: '{{count}} with errors',
    summaryBuilt: 'built {{time}}',
    counts: '{{cmd}} cmd · {{tool}} tool',
    builtAt: 'built {{time}}',
    statError: 'error',
    build: 'Build',
  },
