export const settings = {
  ...
  modelConfigCenter: {
    ...
    help: {
      ...
      apiKey: 'Supports literal keys, environment variable names, or `!command` forms.',
      ...
      reasoning: 'Use this to mark whether the model supports deeper reasoning behavior.',
    },
    empty: {
