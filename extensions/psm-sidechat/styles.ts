export const sideChatStyles = {
  ...
  panel: 'hidden h-full min-h-0 shrink-0 border-l border-border/70 bg-surface-dark/75 xl:flex xl:flex-col',
  ...
  iconButton: 'inline-flex h-7 w-7 items-center justify-center rounded-md border border-border/70 bg-secondary text-muted-foreground hover:bg-secondary-hover hover:text-foreground',
}
