...
/// Build a generic plugin record from the result, ready for SQLite storage.
pub fn to_db_summary(session_path: &str, result: &SessionSummaryResult, provider: &str, model: &str) -> DbPluginRecord {
